...
[
    ...
    ["??$f@$AA@@@YAHXZ", "int f<bit_cast<float>(0x0)>()"],
    ["??$f@$BA@@@YAHXZ", "int f<bit_cast<double>(0x0)>()"],
    ["??$f@$ALPIAAAAA@@@YAHXZ", "int f<bit_cast<float>(0xbf800000)>()"],
    ["??$f@$BLPPAAAAAAAAAAAAA@@@YAHXZ", "int f<bit_cast<double>(0xbff0000000000000)>()"],
